...
<html lang="en">
  ...
  <body>
    ...
    <div class="sidebar">
      ...
      <div class="menu">
        <ul>
          <li><a href = "dashboard_seller.jsp?id2=<%=uid%>"><i class="fa fa-home"></i> Home</a></li>
          <li><a href = "../product/product_added.jsp?id2=<%=uid%>"><i class="fa fa-shopping-basket"></i> Add Product</a></li>
    ...
    <div class="content">
      ...
      <div class="all-products">
		...
		try{ 
			...
			Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/dbds", "root", "Sivaisha12");
			...
			while(rs.next()){
	            ...
	            <a href="product_seller.jsp?id=<%=rs.getString("id") %>">
				<div class="addbutton">
	            ...
	            <% session.setAttribute("id",rs.getString("id")); %>
	              ...
	              <div class="price"><h1><%=rs.getString("price") %> $</h1></div>
	            </div>
	          </div>
