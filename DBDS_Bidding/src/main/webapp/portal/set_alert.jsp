    ...
    <div class="content">
	 ...
	 <form action="setalert"  method="post">
	  ...
	  <tr>
	  	...
	  	<td style="width:150px; padding-bottom: 15px;">Maximum Price</td>
	  	<td style="padding-bottom: 15px;"><input type="text" class="inp" name="price" id="price" placeholder="Select maximum price" required></td>
	  </tr>
	  </table>
	  <input type="hidden" name="user_name" value="<%=uid%>">
